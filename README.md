...
2. Magisk/Play store will be launched. Enjoy by installing LSPosed-zygisk with zygisk enabled or Riru and LSPosed-riru
...
Replace the content of your previous build and rerun `Install.ps1`. Don't worry, your data will be preserved.
